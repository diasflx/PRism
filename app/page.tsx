...
export default function Home() {
  ...
  useEffect(() => {
    const savedHistory = localStorage.getItem('prism-history');
    if (savedHistory) {
      try {
    ...
    const savedDarkMode = localStorage.getItem('prism-darkmode');
  ...
  const saveToHistory = (prUrl: string, prInfo: any, result: AnalysisResult) => {
    ...
    localStorage.setItem('prism-history', JSON.stringify(updatedHistory));
  };
  ...
  const toggleDarkMode = () => {
    ...
    localStorage.setItem('prism-darkmode', (!darkMode).toString());
  };
  ...
  const generateMarkdown = (result: AnalysisResult, prInfo: any) => {
    ...
    markdown += `\n---\n\n*Generated by PRism - Powered by Claude Sonnet 4*\n`;
    return markdown;
  };
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-2xl font-bold">
              <Code2 className="h-7 w-7 text-indigo-600 dark:text-indigo-400" />
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 max-w-5xl">
        ...
        {!result && !loading && (
          <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-slate-900 via-indigo-900 to-slate-900 dark:from-slate-100 dark:via-indigo-300 dark:to-slate-100 bg-clip-text text-transparent">
              PRism
              <br />
              <span className="text-2xl md:text-3xl">Pull Request Intelligent Security & Metrics</span>
            </h1>
